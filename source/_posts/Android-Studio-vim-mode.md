...
---
&nbsp;
![vim](https://raw.githubusercontent.com/weber87na/flowers/master/01.jpg)
<!-- more -->
...
### mutiple-cursors 功能
過年看到群組討論 , 稍微記錄下 , 可以參考[大陸人](https://www.bilibili.com/video/BV1VA411L7Km/)
如果要搭配滑鼠的話 `alt + 滑鼠左鍵` 就可以完成多選 , vscode 好像也是這樣
詳細的話可以看[官方設定](https://github.com/JetBrains/ideavim/wiki/Emulated-plugins#multiple-cursors)
